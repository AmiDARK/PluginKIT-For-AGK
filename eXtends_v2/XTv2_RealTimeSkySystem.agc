...
// XTEnableRTSShadowShadings()
// XTDisableRTSShadowShadings
// XTSetRTSAutoZoom( DefAutoZoomV )
// XTSetRTSClock( Hour, Minutes, TSpeed )
// Day = XTGetRTSDay()
// Hour = XTGetRTSHour()
// Minutes = XTGetRTSMinutes()
// Seconds = XTGetRTSSecunds()
// XTSetRTSDay( Day )
// XTSetRTSHour( Hour )
// XTSetRTSMinutes( Minutes )
// XTSetRTSSecunds( Seconds )
// XTSetRTSTimeExpansion( TSpeed )
// XTSetRTSWindForce( XForce, ZForce )
// XTSetRTSCloudPersistence( PersistanceRatio )
// XTSetRTSMistAlpha( MistRatio )
// XTSetRTSFogControlOn()
// XTSetRTSFogControlOff()
// XTSetRTSFogDistance( Distance )
// XTSetRTSFogColor( Red, Green, Blue )
// XTSetRTSFogColorEx( Red, Green, Blue, MinRed, MinGreen, MinBlue )
// XTClearRTSkybox()
// 3DObjectID = XTGetRTSObjectLoaded( RTSObjectIndex )
// XTRTSUpdate()
// Initialized = XTSetupRTS( SkySystemFile )



//
Function XTEnableRTSShadowShadings()
	RTSSystem.UseShadowsOn = 1
EndFunction

Function XTDisableRTSShadowShadings()
	RTSSystem.UseShadowsOn = 0
EndFunction

Function XTSetRTSAutoZoom( DefAutoZoomV As Float )
	If DefAutoZoomV < 0.0001 : DefAutoZoomV = 0.0001 : EndIf
	RTSSystem.DefAutoZoom = DefAutoZoomV
EndFunction

Function XTSetRTSClock( Hour As Integer, Minutes As Integer, TSpeed As Float )
	// définition de l'heure par défaut ...
	RTSky.Hour = Hour : RTSky.Minutes = Minutes : RTSky.Secunds = 0
	RTSky.TimeSpeed = TSpeed
EndFunction
//
Function XTGetRTSDay()
EndFunction RTSky.Day

Function XTGetRTSHour()
EndFunction RTSky.Hour

Function XTGetRTSMinutes()
EndFunction RTSky.Minutes

Function XTGetRTSSecunds()
EndFunction RTSky.Secunds

Function XTSetRTSDay( VALUE As Integer )
	RTSky.Day = VALUE
EndFunction

Function XTSetRTSHour( VALUE As Integer )
	RTSky.Hour = VALUE
EndFunction

Function XTSetRTSMinutes( VALUE As Integer )
	RTSky.Minutes = VALUE
EndFunction

Function XTSetRTSSecunds( VALUE As Integer )
	RTSky.secunds = VALUE
EndFunction

Function XTSetRTSTimeExpansion( TSpeed As Float )
	RTSky.TimeSpeed = TSpeed
EndFunction

Function XTSetRTSWindForce( XSpeed As Float, ZSpeed As Float ) 
	RTSky.WindXSpeed = XSpeed
	RTSky.WindYSpeed = ZSpeed
EndFunction

Function XTSetRTSCloudPersistence( Value As Float )
...
Function XTSetRTSMistAlpha( Value As Float )
	If Value <= 1.0 : Value = 1.0 : EndIf
	if Value > 255 : Value = 255: Endif
	RTSky.MistPercent = Value
EndFunction

Function XTSetRTSFogControlOn()
	RTSky.FogControl = 1
EndFunction

Function XTSetRTSFogControlOff()
	RTSky.FogControl = 0
EndFunction

Function XTSetRTSFogDistance( Distance As Float )
	RTSky.FogDistance = Distance
EndFunction

Function XTSetRTSFogColor( Red As Integer, Green As Integer, Blue As Integer )
	XTSetRTSFogColorEx( Red, Green, Blue, Red / 10, Green / 10, Blue / 10 )
EndFunction

Function XTSetRTSFogColorEx( Red As Integer, Green As Integer, Blue As Integer, MinRed As Integer, MinGreen As Integer, MinBlue As Integer )
	RTSky.FogRed = Red
...
Function XTGetRTSObjectLoaded( ID As Integer )
EndFunction RTSObjects[ ID ]

Function XTRTSUpdate()
	//
	// *********************************************************************************************************************************************************
	// *                                                                                                                                                       *
	...
	RANGER As Float : RANGER = ( 512.00 * PERCENT ) * RTSSystem.DefAutoZoom
	...
	SetSunActive( 1 )
	ClearPointLights()
	CreatePointLight( 1, XCam1 - ( XPos * 12 * RTSSystem.DefAutoZoom ) , YCam1 - ( YPos * 12 * RTSSystem.DefAutoZoom ) , ZCam1, RANGER, RVB1 , RVB2 , RVB3 )
	...
	If RTSky.FogControl = 1
		...
		RVB1 As Integer : RVB2 As Integer : RVB3 As Integer
...
Function XTSetupRTS( SkyBoxes As String )
	...
	If FileOpened > 0
		...
		RTSSystem.Initialized = -1
	EndIf

	// ********************************************************************************************* 3. Setup the stars
	// 
	RTSObjects[ 2 ] = LoadObject( RTSky.SkyBoxDrawer + "rts_ciel_ver2018.obj" )
	...
	// 
	RTSObjects[ 0 ] = LoadObject( RTSky.SkyBoxDrawer + "rts_ciel_ver2018.obj" )
	...
	// ********************************************************************************************* 8. Setup the clouds
	// 
	RTSObjects[ 1 ] = LoadObject( RTSky.SkyBoxDrawer + "rts_cloudsground_ver2018.obj" )
	...
	// 
	RTSObjects[ 7 ] = LoadObject( RTSky.SkyBoxDrawer + "rts_cloudsground_ver2018.obj" )
	RTSTextures[ 7 ] = LoadImage( RTSky.SkyBoxDrawer + "rts_gris.png", 0 )
	...
	// 
	RTSObjects[ 8 ] = LoadObject( RTSky.SkyBoxDrawer + "rts_lc.x" )
	...
	// 
	RTSObjects[ 9 ] = LoadObject( RTSky.SkyBoxDrawer + "rts_faraway.x" )
	...
	// ********************************************************************************************* 11. Setup the ground
	// 
	RTSObjects[ 6 ] = LoadObject( RTSky.SkyBoxDrawer + RTSky.SkyBoxDrawer + "rts_cloudsground_ver2018.obj" )
